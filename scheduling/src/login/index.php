                    ...
                    <div class="wrap">
                        <div class="login-wrap p-4 p-md-5">
                            <div class="text-center mb-4">
                                ...
                                <h3 class="mb-4" style="font-weight: bold; color: #2b1219;">Logar</h3>
                            </div>
                            ...
                            <p class="text-center">Ainda não é membro? <a data-toggle="tab" href="../register/index.php" style="color: #d01669;">Cadastre-se</a></p>
                        </div>
                    </div>
                </div>
            </div>
